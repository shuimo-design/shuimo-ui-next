...
import { MBorder, type MBorderProps } from ".";
...
const BOX: React.CSSProperties = { width: 240, height: 80 };

async function mountBorder(props: MBorderProps = {}) {
  const screen = await render(
    <MBorder seed={2} style={BOX} {...props}>
      山水
    </MBorder>,
  );
